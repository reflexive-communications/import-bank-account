...
class CRM_ImportBankAccount_Contribution_CustomField_Parser extends CRM_Contribute_Import_Parser_Contribution
{
    /**
    ...
    public function init()
    {
        ...
        $fields = array_merge($fields, CRM_ImportBankAccount_Service::customTextFields());
    ...
    public function summary(&$values)
    {
        ...
        $toUnset = CRM_ImportBankAccount_Service::extractCustomTextFields(array_keys($params));
    ...
    public function import($onDuplicate, &$values)
    {
        ...
        if ($onDuplicate == CRM_Import_Parser::DUPLICATE_SKIP &&
            (!empty($paramValues['contribution_contact_id']) || count(CRM_ImportBankAccount_Service::extractCustomTextFields(array_keys($paramValues))) === 1)
        ) {
     ...
     * Based on the legacy solution: https://github.com/civicrm/civicrm-core/blob/5db0bc3c1f54eaca4307f103a73bda596ae914d6/CRM/Contribute/Import/Parser/Contribution.php#L605-L994
     *
     * @param array $params
        ...
        foreach ($params as $key => $value) {
            ...
            case 'contribution_contact_id':
                ...
                $svq = $dao->singleValueQuery(
                    "SELECT is_deleted FROM civicrm_contact WHERE id = $value",
                    $qParams
                );
                if (!isset($svq)) {
                    ...
                    foreach ($params[$key] as $softKey => $softParam) {
                        ...
                        if ($contactId || $externalId) {
                            ...
                            if (!$contact->find(true)) {
                                ...
                                $errorMsg = ts(
                                    "Soft Credit %1 - %2 doesn't exist. Row was skipped.",
